                ...
                <footer>
                    <Trans>
                        By registering you agree to our <NavLink target={'_blank'}
                                                                 to={getConfig("VITE_TOS_URL", "https://kamplove.org/terms-conditions") as string}>Terms
                        of Service</NavLink> and <NavLink
                        target={'_blank'}
                        to={getConfig("VITE_PRIVACY_URL", 'https://kamplove.org/privacy-policy') as string}>Privacy Policy</NavLink>.
                    </Trans>
                </footer>
            </div>
        </>
